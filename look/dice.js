...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-0e540f56');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-0e540f56');}
...
var brandEl=document.querySelector('.rl-brand-0e540f56');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
